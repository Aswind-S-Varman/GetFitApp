    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="tracking/{{$tracking}}/show">Tracking Session</a></li>
                        <li class="nav-item"><a class="nav-link" href= 'profiles/{{$profile}}/show' >Profile</a></li>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-heading text-uppercase">Trainee</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#video">Show Me More</a>
            </div>
        </header>
